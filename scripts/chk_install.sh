...
APT_GET_INSTALL="python3 python3-pip python3-venv libatlas3-base fonts-freefont-ttf fake-hwclock cifs-utils libfreetype6-dev libjpeg-dev build-essential openssl"
