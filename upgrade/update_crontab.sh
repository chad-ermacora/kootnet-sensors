...
printf '1. autoStartSensor_Interval_To_DB.py (Run every 1 min to start if NOT running)\n'
...
echo '*/1 * * * * bash /home/sensors/auto_start/autoStartSensor_Interval_To_DB.sh' >> /home/pi/tmp34441.txt
