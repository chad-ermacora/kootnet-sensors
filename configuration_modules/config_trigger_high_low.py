...
class CreateTriggerHighLowConfiguration(CreateGeneralConfiguration):
    ...
    def __init__(self, load_from_file=True):
        ...
        self.config_settings_names = [
            ...
            "Particulate Matter 2.5 (PM2.5) High Trigger", "Particulate Matter 10 (PM10) Low Trigger",
    ...
    def update_with_html_request(self, html_request):
        ...
        if html_request.form.get("red") is not None:
            self.red_low = float(html_request.form.get("red"))
        if html_request.form.get("orange") is not None:
            self.orange_low = float(html_request.form.get("orange"))
        if html_request.form.get("yellow") is not None:
            self.yellow_low = float(html_request.form.get("yellow"))
        if html_request.form.get("green") is not None:
            self.green_low = float(html_request.form.get("green"))
        if html_request.form.get("blue") is not None:
            self.blue_low = float(html_request.form.get("blue"))
        if html_request.form.get("violet") is not None:
            self.violet_low = float(html_request.form.get("violet"))
        ...
        if html_request.form.get("ultra_violet_a") is not None:
            self.ultra_violet_a_low = float(html_request.form.get("ultra_violet_a"))
        if html_request.form.get("ultra_violet_b") is not None:
            self.ultra_violet_b_low = float(html_request.form.get("ultra_violet_b"))
        ...
        if html_request.form.get("accelerometer_x") is not None:
            self.accelerometer_x_low = float(html_request.form.get("accelerometer_x"))
        if html_request.form.get("accelerometer_y") is not None:
            self.accelerometer_y_low = float(html_request.form.get("accelerometer_y"))
        if html_request.form.get("accelerometer_z") is not None:
            self.accelerometer_z_low = float(html_request.form.get("accelerometer_z"))
        ...
        if html_request.form.get("magnetometer_x") is not None:
            self.magnetometer_x_low = float(html_request.form.get("magnetometer_x"))
        if html_request.form.get("magnetometer_y") is not None:
            self.magnetometer_y_low = float(html_request.form.get("magnetometer_y"))
        if html_request.form.get("magnetometer_z") is not None:
            self.magnetometer_z_low = float(html_request.form.get("magnetometer_z"))
        ...
        if html_request.form.get("gyroscope_x") is not None:
            self.gyroscope_x_low = float(html_request.form.get("gyroscope_x"))
        if html_request.form.get("gyroscope_y") is not None:
            self.gyroscope_y_low = float(html_request.form.get("gyroscope_y"))
        if html_request.form.get("gyroscope_z") is not None:
            self.gyroscope_z_low = float(html_request.form.get("gyroscope_z"))
    ...
    def _update_configuration_settings_list(self):
        ...
        self.config_settings = [
            ...
            str(self.particulate_matter_2_5_high), str(self.particulate_matter_10_low),
    ...
    def _update_variables_from_settings_list(self):
        try:
            ...
            self.particulate_matter_10_low = float(self.config_settings[39])
            self.particulate_matter_10_low = float(self.config_settings[40])
            self.particulate_matter_wait_seconds = float(self.config_settings[41])
            self.lumen_enabled = int(self.config_settings[42])
            self.lumen_low = float(self.config_settings[43])
            self.lumen_low = float(self.config_settings[44])
            self.lumen_wait_seconds = float(self.config_settings[45])
            self.colour_enabled = int(self.config_settings[46])
            self.red_low = float(self.config_settings[47])
            self.red_low = float(self.config_settings[48])
            self.orange_low = float(self.config_settings[49])
            self.orange_low = float(self.config_settings[50])
            self.yellow_low = float(self.config_settings[51])
            self.yellow_low = float(self.config_settings[52])
            self.green_low = float(self.config_settings[53])
            self.green_low = float(self.config_settings[54])
            self.blue_low = float(self.config_settings[55])
            self.blue_low = float(self.config_settings[56])
            self.violet_low = float(self.config_settings[57])
            self.violet_low = float(self.config_settings[58])
            self.colour_wait_seconds = float(self.config_settings[59])
            self.ultra_violet_enabled = int(self.config_settings[60])
            self.ultra_violet_index_low = float(self.config_settings[61])
            self.ultra_violet_index_low = float(self.config_settings[62])
            self.ultra_violet_a_low = float(self.config_settings[63])
            self.ultra_violet_a_low = float(self.config_settings[64])
            self.ultra_violet_b_low = float(self.config_settings[65])
            self.ultra_violet_b_low = float(self.config_settings[66])
            self.ultra_violet_wait_seconds = float(self.config_settings[67])
            self.accelerometer_enabled = int(self.config_settings[68])
            self.accelerometer_x_low = float(self.config_settings[69])
            self.accelerometer_x_low = float(self.config_settings[70])
            self.accelerometer_y_low = float(self.config_settings[71])
            self.accelerometer_y_low = float(self.config_settings[72])
            self.accelerometer_z_low = float(self.config_settings[73])
            self.accelerometer_z_low = float(self.config_settings[74])
            self.accelerometer_wait_seconds = float(self.config_settings[75])
            self.magnetometer_enabled = int(self.config_settings[76])
            self.magnetometer_x_low = float(self.config_settings[77])
            self.magnetometer_x_low = float(self.config_settings[78])
            self.magnetometer_y_low = float(self.config_settings[79])
            self.magnetometer_y_low = float(self.config_settings[80])
            self.magnetometer_z_low = float(self.config_settings[81])
            self.magnetometer_z_low = float(self.config_settings[82])
            self.magnetometer_wait_seconds = float(self.config_settings[83])
            self.gyroscope_enabled = int(self.config_settings[84])
            self.gyroscope_x_low = float(self.config_settings[85])
            self.gyroscope_x_low = float(self.config_settings[86])
            self.gyroscope_y_low = float(self.config_settings[87])
            self.gyroscope_y_low = float(self.config_settings[88])
            self.gyroscope_z_low = float(self.config_settings[89])
            self.gyroscope_z_low = float(self.config_settings[90])
            self.gyroscope_wait_seconds = float(self.config_settings[91])
