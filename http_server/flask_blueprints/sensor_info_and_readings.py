...
def html_trigger_status():
    return render_template(
        ...
        TriggerVarianceAltitude=app_cached_variables.trigger_thread_altitude.current_state,
        TriggerVarianceHumidity=app_cached_variables.trigger_thread_humidity.current_state,
        TriggerVarianceDistance=app_cached_variables.trigger_thread_distance.current_state,
        TriggerVarianceLumen=app_cached_variables.trigger_thread_lumen.current_state,
        TriggerVarianceVisibleEMS=app_cached_variables.trigger_thread_visible_ems.current_state,
        TriggerVarianceUltraViolet=str(app_cached_variables.trigger_thread_ultra_violet.current_state),
        TriggerVarianceGAS=str(app_cached_variables.trigger_thread_gas.current_state),
        TriggerVariancePM=str(app_cached_variables.trigger_thread_particulate_matter.current_state),
        TriggerVarianceAccelerometer=app_cached_variables.trigger_thread_accelerometer.current_state,
        TriggerVarianceMagnetometer=app_cached_variables.trigger_thread_magnetometer.current_state,
        TriggerVarianceGyroscope=app_cached_variables.trigger_thread_gyroscope.current_state,
