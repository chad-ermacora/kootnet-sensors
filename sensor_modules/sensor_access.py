...
class CreateSensorHTTP:
    def __init__(self):
        ...
        def get_all_gas():
            ...
            gas_return = [sensors.get_gas_resistance_index(),
                          sensors.get_gas_oxidised(),
                          sensors.get_gas_reduced(),
                          sensors.get_gas_nh3()]
        ...
        def get_all_particulate_matter():
            ...
            return_pm = [sensors.get_particulate_matter_1(),
                         sensors.get_particulate_matter_2_5(),
                         sensors.get_particulate_matter_10()]
        ...
        def get_all_ultra_violet():
            ...
            return_ultra_violet = [sensors.get_ultra_violet_a(), sensors.get_ultra_violet_b()]
