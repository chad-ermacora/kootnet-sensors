import time
from sensor_modules.drivers.i2cdevice import Device, Register, BitField
from sensor_modules.drivers.i2cdevice.adapter import Adapter, LookupAdapter, U16ByteSwapAdapter
import datetime
