...
def run_tests():
    ...
    print("Testing Sensor: " + str(test_http_server.sensor_address) + ":" + tmp_port)
    print("Run at DateTime: " + strftime("%Y-%m-%d %H:%M - %Z") + "\n")
...
app_textbox_ip = guizero.TextBox(app, text="localhost", width=25, grid=[2, 1], align="left")
app_button_test_sensor = guizero.PushButton(app, text="Test Sensor", command=button_go, grid=[3, 1], align="right")
